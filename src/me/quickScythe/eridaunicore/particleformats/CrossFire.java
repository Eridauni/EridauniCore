...
public class CrossFire implements Runnable {
	...
	public void run() {
		...
		l = CoreUtils.getVerticalCircleLocation(CoreUtils.getParticleTimer(player), 1.0, player.getLocation());
		l2 = CoreUtils.getCircleLocation(CoreUtils.getParticleTimer(player), 1.0, player.getLocation());
		l2.setY(l2.getY() +1);
